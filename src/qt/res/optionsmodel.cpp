...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizelivermoriumAmount"))
        settings.setValue("nAnonymizelivermoriumAmount", 1000);
    nAnonymizelivermoriumAmount = settings.value("nAnonymizelivermoriumAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizelivermoriumAmount"))
        SoftSetArg("-anonymizelivermoriumamount", settings.value("nAnonymizelivermoriumAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizelivermoriumAmount:
            return QVariant(nAnonymizelivermoriumAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizelivermoriumAmount:
            nAnonymizelivermoriumAmount = value.toInt();
            settings.setValue("nAnonymizelivermoriumAmount", nAnonymizelivermoriumAmount);
            emit AnonymizelivermoriumAmountChanged(nAnonymizelivermoriumAmount);
            break;
        default:
            break;
        }
