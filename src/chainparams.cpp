...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04efa3a220581895b2a273a733989e10bd15f9cf7bfc26fcfc2d72d584378bd208c59f7809220154bd808b53ccbd422e864f359105f277a30026752fd404a0fc76");
        nDefaultPort = 7799;
        nRPCPort = 7798;
        ...
        const char* pszTimestamp = "livermorium - Masternodes - POW - POS ";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1532602800, vin, vout, 0);
        ...
        assert(hashGenesisBlock == uint256("0x92bd300ab7168ae641913070c68d6d1fb2335332da8cf9c7e0e61028d8226085"));
        assert(genesis.hashMerkleRoot == uint256("0x6b53eb993094972cb99116462bda4ef10b4986cd3521e4eaf4acbcb7f89b0295"));
        ...
        vSeeds.push_back(CDNSSeedData("0",  "91.200.102.145")); //
//        vSeeds.push_back(CDNSSeedData("1",  ""));
        ...
        strDarksendPoolDummyAddress = "LVjui6eyjMHU37MLKr4qb49jURXr2f3ApK";


        nLastPOWBlock = 2500000;
        nPOSStartBlock = 1;
    }
