...
const string strMessageMagic = "livermorium Signed Message:\n";
...
static int64_t nTargetTimespan = 10 * 60;  // 1 mins
...
{
	RenameThread("livermorium-loadblk");
